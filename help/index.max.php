...
<!-------------------------------------------------------------------------------------------------------------------------------------------->
			...
			— Радио останавливается при переходе на другую страницу. К сожалению, из-за соображений удобства и безопасности, браузеры не позволяют нам сразу продолжить вопроизведение, как только вы зашли на страницу. Поэтому мы ждём, пока вы щёлкните куда-либо и сразу включаем музыку.
