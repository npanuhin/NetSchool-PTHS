...
<!-------------------------------------------------------------------------------------------------------------------------------------------->
			...
			<p>— Вам не требуется авторизация каждый раз, когда Вы заходите на сайт. У нас более удобные отображения расписания, оценок и домашних заданий. Здесь же Вы удобно представлены ссылки на дистанционные уроки и спецкурсы. Можно сразу слушать музыку, чтобы придти в себя после увиденного в дневнике…</p>
			<p>У нас адекватная мобильная версия сайта, темная тема, и еще куча прикольных плюшек, которые еще делаются. Ну и, наконец, стабильность. Этот нетскул не напрямую зависит от основного, и смотреть на дневник, домашние задания и расписание можно даже если основной сайт лежит (увы, такое часто бывает…). </p>
			
			<div class="question" id="question-use-always">— Значит ли это, что я могу всегда пользоваться только этим нетскулом?</div>
			— Де-факто — да. Но если Вы не хотите себе внезапных неприятностей, то лучше изредка заглядывать в основной нетскул, чтобы, как минимум, проверить почту. Не повторяйте ошибки одного из разработчиков, которому информацию, необходимую для поездки на Всерос, прислали по почте Нетскула, куда он не заходил…
			
			<div class="question" id="question-help">— Я хочу чем-нибудь помочь в разработке!</div>
			— Это было бы круто. Мы "доживаем" последнюю четверть в ФТШ, и пока у нас нет никого, кому бы можно было бы поручить продолжить наше дело. Честно признаться, код у нас нисколько не документирован, code-style иногда не выдерживается, опыта не безумное количество, и "быстрый вход" не гарантируем. Но, если у Вас есть желание что-нибудь сделать (только желательно быть серьезно настроенным, не просто кнопку в другой цвет перекрасить), даже если нет опыта работы с PHP, SCSS или JS, то присоединяйтесь, не проблема, разберемся. 
			...
			— Вы можете всегда удалить свой аккаунт. С этого момента мы не будет обновлять Ваши данные. Также это удалит Ваши логин и пароль из базы данных (здесь Вам придется поверить в нашу честность). Если Вы захотите вернуться, Вам придется заново пройти регистрацию, что займет длительное время. Удалить страницу можно по <a title = "Точно не будете в техподдержку не писать о том, что не понравилось?(" href="/delete/" target="_blank">ссылке</a>.
...
<!-------------------------------------------------------------------------------------------------------------------------------------------->
			...
			— Радио останавливается при переходе на другую страницу. К сожалению, из-за соображений удобства и безопасности, браузеры не позволяют нам сразу продолжить вопроизведение, как только останавливаетсяы зашли на страницу. Поэтому мы ждём, пока Вы щёлкните куда-нибудь и сразу включаем музыку.
...
<!-------------------------------------------------------------------------------------------------------------------------------------------->
			...
			— Это известный баг, который мы вроде починили. Если он вернулся — то либо мы что-то тестируем, либо он вернулся (если Вы его видите, то, пожалуйста, сообщите).
			
			<div class="question" id="question-mail">— Вы будете добавлять почту?</div>
			— Достаточно сложно сделать полноценную систему, которая, во-первых, правильно считывает извращенные методы отображения почты нетскулом, а, во-вторых, которая сама способна это все дело нормально отображать и быть удобной. Так что, видимо, пока не появятся дополнительные люди с горящими глазами и прямыми руками…
			
			<div class="question" id="question-statistics">— Просто подсчет среднего балла — это как-то неинтересно. А может, хотя бы построить график динамики среднего балла от времени <span class="del" title="Вот и тема для чьей-нибудь практики…">и исследовать моды их колебаний через преобразования Фурье</span>?</div>
			— Ну вот что-то такое мы сейчас и делаем, это должно быть более информативно, чем динамика среднего балла в нетскуле. Правда, чужие данные мы считывать для расчета среднего балла по классу не будем (это как какая-то слежка получается), но посмотрим еще. Это будет между "FAQ" и "Объявлениями" (а вы думали, зачем там пустое место?). 
