...
<body>
	...
	<main>
		...
		<div class="help">
			...
			— Вы можете всегда удалить свой аккаунт. С этого момента мы не будет обновлять ваши данные. Также это удалит ваши логин и пароль из базы данных (здесь Вам придется поверить в нашу честность). Если Вы захотите вернуться, Вам придется заново пройти регистрацию, что займет длительное время. Удалить страницу можно по <a href = "https://netschool.npanuhin.me/delete/" target="_blank">ссылке</a>.  
