...
<body>
	...
	<main>
		...
		<div class="help">
			...
			— Мы получаем данные через <a href="https://ru.wikipedia.org/wiki/Веб-скрейпинг" target="_blank">парсинг</a> обычного нетскула, и нам нужны «чистые» логин и пароль для того, чтобы получить доступ для обновления. Но мы их не используем (и никому не передаем), кроме случаев, когда нам нужно срочно что-то починить.
